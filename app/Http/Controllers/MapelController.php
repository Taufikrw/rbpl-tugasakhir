...
class MapelController extends Controller
{
    ...
    {
        return view('admin.mapel.table', [
            "title" => "Mata Pelajaran",
            "slug" => "mata-pelajaran",
            "role" => "admin",
            "mapel" => Mapel::all()->sortBy('idClass'),
            "grant" => [
                [
                    'Name' => 'Siswa',
                    'slug' => 'siswa',
    ...
    {
        return view('admin.mapel.update', [
            "title" => "Mata Pelajaran",
            "slug" => "mata-pelajaran",
            "role" => "admin",
            "mapel" => Mapel::find($id),
    ...
    public function update(Request $request, String $id)
    {
        ...
        Mapel::where('id', $mapel->id)->update($validate);
        return redirect('/admin/mata-pelajaran/'.$mapel->id)->with('success', 'Data berhasil diupdate');
    }
