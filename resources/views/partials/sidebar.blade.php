<div class="">
    <div id="sidebar" class="flex flex-col relative top-0 left-0 h-screen md:w-64 w-16 bg-slate-200 text-white shadow-lg overflow-y-scroll scrollbar-none">
        <div class="flex flex-col mb-4">
            ...
            <a href="#" class="sidebar-link">
                ...
                <span class="hidden md:block ml-2 uppercase font-bold">Siswa</span>
            </a>
            {{-- Teacher Link --}}
            <a href="#" class="sidebar-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 ml-3">
                ...
                <span class="hidden md:block ml-2 uppercase font-bold">Guru</span>
            </a>
            {{-- Lesson Link --}}
            <a href="#" class="sidebar-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 ml-3">
                ...
                <span class="hidden md:block ml-2 uppercase font-bold">Mata Pelajaran</span>
            </a>
            {{-- Class Link --}}
            <a href="#" class="sidebar-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 ml-3">
                ...
                <span class="hidden md:block ml-2 uppercase font-bold">Kelas</span>
            </a>
        </div>
        {{-- Canvas --}}
        <div class="flex flex-col border-t-2 border-slate-300 pt-4">
            <a href="#" class="sidebar-link">
                ...
                <span class="hidden md:block ml-2 uppercase font-bold">Contoh</span>
            </a>
            </a>
        </div>
    </div>
