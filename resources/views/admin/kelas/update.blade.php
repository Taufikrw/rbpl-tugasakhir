...
@section('content')
    <div class="container h-full px-72 py-12">
        ...
        <div class="flex flex-wrap border h-fit rounded-lg shadow-md p-10">
            <form action="{{ route('kelas.update', $kelas->id) }}" method="post" class="w-full">
                @method('put')
                @csrf
                <div class="mb-4">
                    ...
                    value="{{ old('classLevel', $kelas->classLevel) }}">
                    @error('classLevel')
                ...
                @enderror"
                        ...
                        value="{{ old('className', $kelas->className) }}">
                    @error('className')
                        <div class="text-sm text-pink-700 ml-1">{{ $message }}</div>
                    @enderror
                </div>
                ...
                @enderror"
                        ...
                        value="{{ old('classYear', $kelas->classYear) }}">
                    @error('classYear')
                        <div class="text-sm text-pink-700 ml-1">{{ $message }}</div>
                    @enderror
                </div>
