                    ...
                    <thead>
                        <tr>
                            <th class="py-2 px-4 border font-semibold uppercase sticky top-0 bg-slate-500 text-white">Nama
                                Mata Pelajaran</th>
                            <th class="py-2 px-4 border font-semibold uppercase sticky top-0 bg-slate-500 text-white">Action
                            </th>
                        </tr>
                    </thead>
                    <tbody>
                        @foreach ($daftarMapel as $content)
                            <tr class="hover:bg-indigo-500 hover:text-white duration-200 ease-in">
                                <td class="py-2 px-4 border-b">{{ $content->matkulName }}</td>
                                <td class="py-2 px-4 border-b">
                                    <a href="/guru/lihat-nilai/{{ $content->id }}">
