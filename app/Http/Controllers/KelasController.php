...
class KelasController extends Controller
{
    ...
    public function index()
    {
        return view('admin.kelas.table', [
            ...
            "slug" => "kelas",
            "role" => "admin",
            "kelas" => Kelas::all()->sortBy('className')->sortBy('classLevel'),
            "grant" => [
                [
                    'Name' => 'Siswa',
                    'slug' => 'siswa',
    ...
    public function show(String $id)
    {
        return view('admin.kelas.show', [
            ...
            "role" => "admin",
            "kelas" => Kelas::find($id),
            "list" => Siswa::all()->where('idClass', $id)->sortBy('firstName'),
            "grant" => [
                [
                    'Name' => 'Siswa',
                    'slug' => 'siswa',
    ...
    public function update(Request $request, String $id)
    {
        ...
        Kelas::where('id', $kelas->id)->update($validate);
        return redirect('/admin/kelas/'.$kelas->id)->with('success', 'Data berhasil diupdate');
    }
