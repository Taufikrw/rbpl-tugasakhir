<div id="sidebar"
    ...
    <div class="flex flex-col mb-4">
        <img class="h-8 w-auto mt-4 mb-6" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600"
            alt="logo">
        <?php $__currentLoopData = $grant; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sidebarContent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <a href="/admin/<?php echo e($sidebarContent['slug']); ?>" class="sidebar-link">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
                    class="w-6 h-6 ml-3"><?php echo $sidebarContent['Icon']; ?></svg>
                <span class="hidden md:block ml-2 uppercase font-bold"><?php echo e($sidebarContent['Name']); ?></span>
            </a>
...
<?php /**PATH D:\tugasAkhirRBPL\rbpl-tugasakhir\resources\views/partials/sidebar.blade.php ENDPATH**/ ?>